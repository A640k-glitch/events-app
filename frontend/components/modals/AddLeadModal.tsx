...
export default function AddLeadModal({ isOpen, onClose }: AddLeadModalProps) {
  ...
  return (
    ...
    >
      <div 
        className="w-full max-w-lg bg-white border border-slate-300 shadow-2xl rounded-xl p-4 sm:p-5 space-y-3.5 max-h-[90vh] overflow-y-auto font-sans text-left text-slate-900 overscroll-contain"
