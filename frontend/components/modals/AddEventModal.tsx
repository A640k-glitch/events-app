        ...
        <div className="flex items-center justify-between border-b border-slate-100 pb-2.5">
          <div>
            <h2 className="text-sm font-bold text-slate-900 tracking-tight flex items-center gap-1.5">
              <Calendar className="w-4 h-4 text-[#005B6E]" /> Publish New Event Schedule
            </h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-3 text-xs">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-2.5 items-center">
            ...
            <div className="flex items-center gap-2 pt-4">
              ...
              />
              <label htmlFor="isFeatured" className="font-semibold text-slate-800 text-[11px] cursor-pointer flex items-center gap-1">
            ...
            <div className="flex items-center gap-2 pt-4">
              <input
                ...
                className="w-4 h-4 text-[#005B6E] rounded border-slate-300 focus:ring-[#005B6E]"
              />
              <label htmlFor="isPublished" className="font-semibold text-slate-800 text-[11px] cursor-pointer">
