...
export default function RegisterPassModal(props: RegisterPassModalProps) {
  ...
  const modalContent = (
    <>
      ...
      >
        <div
          className="w-full max-w-lg bg-white border border-gray-200 rounded-3xl p-6 sm:p-8 space-y-6 text-left shadow-2xl relative overflow-hidden font-sans my-auto max-h-[90vh] overflow-y-auto text-[#0E0E0E] overscroll-contain"
